# -*- coding: utf-8 -*-
"""
CHLADNI PLATE MATHEMATICAL MODEL
This is a model of a chladni plate that predicts some of the standing wave patterns. The resulting graph
shows the average amplitude of vibrations on the plate over one period v.s. x and y position on the plate.
